          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              <div className="flex items-center space-x-2 mb-4">
                <FiDroplet className="w-6 h-6 text-primary-500" />
                <span className="text-xl font-bold text-white">AquaBeacon</span>
              </div>
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://wa.me/254712345678" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                  <FaWhatsapp size={20} />
                </a>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a
                    href="https://wa.me/254712345678?text=Hi,%20I%20need%20support%20with%20AquaBeacon"
                    target="_blank"
                    rel="noopener noreferrer"
