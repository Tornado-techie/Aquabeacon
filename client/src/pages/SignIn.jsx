...
const SignIn = () => {
  ...
  useEffect(() => {
    ...
    if (roleParam && ['owner', 'inspector', 'consumer'].includes(roleParam)) {
      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center space-x-2">
            <FiDroplet className="w-10 h-10 text-primary-600" />
            <span className="text-3xl font-bold text-gray-900">AquaBeacon</span>
          </Link>
