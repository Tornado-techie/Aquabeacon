...
const KnowledgeHub = () => {
  ...
  // Check if user came from water safety link
  useEffect(() => {
    const searchParams = new URLSearchParams(location.search);
    if (searchParams.get('section') === 'water-safety') {
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
                  <div className="text-sm text-gray-600 bg-gray-50 p-3 rounded">
                    "How do I start a water business in Kenya?"
                  </div>
                  <div className="text-sm text-gray-600 bg-gray-50 p-3 rounded">
                    "What equipment do I need for water purification?"
                  </div>
                  <div className="text-sm text-gray-600 bg-gray-50 p-3 rounded">
                    "How to get KEBS certification?"
                  </div>
                  <div className="text-sm text-gray-600 bg-gray-50 p-3 rounded">
                    "What should I do if my water tastes metallic?"
                  </div>
                  <div className="text-sm text-gray-600 bg-gray-50 p-3 rounded">
                    "How often should I test my water quality?"
                  </div>
                  <div className="text-sm text-gray-600 bg-gray-50 p-3 rounded">
                    "What are the KEBS standards for drinking water?"
                  </div>
                </div>
              </div>
            </div>
